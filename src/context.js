...
import {Vector2} from "./libs/three/three.module.js";
...
var GlobalContext = {
    ...
    basisStatesProperties: {
        "pz-state": new Vector2(0, 0),
        "nz-state": new Vector2(180, 0),
        "px-state": new Vector2(90, 0),
        "nx-state": new Vector2(90, 180),
        "py-state": new Vector2(90, 90),
        "ny-state": new Vector2(90, 270),
    },
